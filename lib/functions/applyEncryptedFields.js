...
const applyEncryptedFields = (props) => {
    ...
    fields.forEach((field) => {
        ...
        if (path && path.instance === 'String') {
            ...
            encryptedFieldsPatch[field] = Object.assign(Object.assign({}, originalOptions), { type: Types.String, set: (value) => (value != null ? encrypt(value) : value), get: (value) => (value != null ? decrypt(value) : value) });
        }
        else {
            console.warn(`Field ${field} not found or not a string`);
        }
    });
